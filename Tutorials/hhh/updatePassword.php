...
<body>
    <?php 
        ...
        if (isset($_GET['email']) && isset($_GET['reset_token'])) {
            ...
            $sql="SELECT * FROM testing WHERE email = '$email' AND resettoken = '$reset_token' AND resettokenexp = '$date'";
        ...
        if (isset($_POST['update'])) {
            ...
            $update = "UPDATE testing SET password='$pass',resettoken='NULL',resettokenexp=NULL WHERE email = '$email'";
