<?php
    ...
    if(isset($_POST['surveyUpdate'])){
        ...
        if(count($error)==0){
                $result=mysqli_query($conn,"UPDATE survey SET studentname='$studentname',major='$major',year='$year',language='$language',university='$university',studentlist='$studentlist' WHERE id='$id'");
               }
               if($result){
